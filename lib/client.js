...
var conversationCssInjected = false;
...
function ensureRaiseStyle() {
  const css = "." + RAISED_CLASS + ' { z-index: 200 !important; }[class*="tabBar"] { position: relative !important; z-index: 200 !important; }[class*="sessionLogButton"] { position: relative !important; z-index: 200 !important; }.shlrail_fixed { z-index: 201 !important; }.shlrail_tooltip { z-index: 202 !important; }';
...
// src/client/sidebar-folder-icon.js
var CSS_ID3 = "dsh-appearance/sidebar-folder-icon.css";
var STABLE_FOLDER_ICON_CSS = `
...
`;
function applyStableProjectFolderIcon(cfg) {
  const enabled = cfg?.stableProjectFolderIcon !== false;
  let style = document.querySelector(`style[data-plugin-css="${CSS_ID3}"]`);
  if (enabled && !style) {
...
// src/client/sidebar-icon-align.js
var CSS_ID4 = "dsh-appearance/sidebar-icon-align.css";
var ICON_ALIGN_CSS = `
[class*="_settingsArea"] [class*="_trigger"] { margin-left: 0 !important; }
`;
function applySidebarIconAlign(cfg) {
  const enabled = cfg?.alignSidebarIcons !== false;
  let style = document.querySelector(`style[data-plugin-css="${CSS_ID4}"]`);
  if (enabled && !style) {
    style = document.createElement("style");
    style.dataset.plugin = "dsh-appearance";
    style.dataset.pluginCss = CSS_ID4;
...
var CSS_ID5 = "dsh-appearance/background.css";
...
function applyBackground(cfg) {
  const style = document.querySelector(`style[data-plugin-css="${CSS_ID5}"]`);
...
function AppearanceSection({ t, scope }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-appearance-section", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh-appearance-divider" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "dsh-appearance-switch-row", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsh-appearance-switch-desc", children: t("sidebar.folderIconDesc") })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "dsh-appearance-switch-row", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsh-appearance-switch-desc", children: t("sidebar.iconAlignDesc") })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
